...
Add files to `data/raw/tmc_sources/`:
...
**Python Version Issues** - Use Python 3.11 or 3.12. Python 3.13+ may not have compatible PyTorch wheels. Check:

```powershell
py -3.12 --version
```

**CUDA/GPU Not Detected** - Verify:
